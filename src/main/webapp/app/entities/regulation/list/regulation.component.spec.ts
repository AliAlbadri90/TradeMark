...
describe('Regulation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'regulation', component: RegulationComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.regulations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
