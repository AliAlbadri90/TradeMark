...
export class ComplaintComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.complaintService
        ...
        .subscribe({
          next: (res: HttpResponse<IComplaint[]>) => {
  ...
  trackId(index: number, item: IComplaint): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IComplaint[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
