...
describe('Minister Management Component', () => {
  let comp: MinisterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MinisterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ministers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
