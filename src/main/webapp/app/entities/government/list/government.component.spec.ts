...
describe('Government Management Component', () => {
  let comp: GovernmentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GovernmentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.governments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
