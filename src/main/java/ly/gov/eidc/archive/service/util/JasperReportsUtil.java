...
public class JasperReportsUtil {
    ...
    public JasperPrint getReport(Map<String, Object> parameters, String japerFileName) {
        log.debug("JasperReportsUtil.getReportAsPDF parameters={} , fileName={} ", parameters, japerFileName);
        Connection connection = null;
        ...
        try {
            ...
            // ClassPathResource jasperFile = new ClassPathResource(reportsRootDirectory +
            // "invoicee.jrxml");
    ...
    public byte[] reportConcatenation(JasperPrint page1, JasperPrint page2) throws JRException {
        byte[] reportBytes = null;

        for (JRPrintPage page : page2.getPages()) {
            page1.addPage(page);
        }
        reportBytes = JasperExportManager.exportReportToPdf(page1);
