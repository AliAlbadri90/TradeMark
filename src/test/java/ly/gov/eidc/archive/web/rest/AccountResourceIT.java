...
import static ly.gov.eidc.archive.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ly.gov.eidc.archive.IntegrationTest;
import ly.gov.eidc.archive.config.Constants;
import ly.gov.eidc.archive.domain.User;
import ly.gov.eidc.archive.repository.AuthorityRepository;
import ly.gov.eidc.archive.repository.UserRepository;
import ly.gov.eidc.archive.security.AuthoritiesConstants;
import ly.gov.eidc.archive.service.UserService;
import ly.gov.eidc.archive.service.dto.AdminUserDTO;
import ly.gov.eidc.archive.service.dto.PasswordChangeDTO;
import ly.gov.eidc.archive.service.dto.UserDTO;
import ly.gov.eidc.archive.web.rest.vm.KeyAndPasswordVM;
import ly.gov.eidc.archive.web.rest.vm.ManagedUserVM;
